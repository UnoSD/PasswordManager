...
namespace Paccia
{
    public class AesEncryptorDecryptor
    {
        ...
        public async Task EncryptDecrtyptStreamAsync(SecureString passphrase, byte[] saltBytes, Stream destinationStream, Stream sourceStream, Func<Aes, ICryptoTransform> transform)
        {
